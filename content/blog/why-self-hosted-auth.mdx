...
Concretely, it is a table you could read yourself:
...
Your session is a row beside it, which is why signing out of one device takes effect straight away: ending a session is deleting a row, not waiting for a token to expire somewhere else.
